...
\begin{table}
    \begin{tabular}{llccccccc}
        ...
        & & H-H & H-HL & H-L & L-L & L-H & L-HL\footnotemark{} & H-\textsuperscript{↓}H\\
        \midrule
         Alternation 1 & H-H & & & & & & &  \\
         & H-L & & & & & & &  \\
...
\begin{figure}
\includegraphics[width=.5\textwidth]{figures/glewwe-img2.png}
...
\begin{figure}
\includegraphics[width=.5\textwidth]{figures/glewwe-img3.png}
...
\begin{figure}
\includegraphics[width=.6\textwidth]{figures/glewwe-img4.png}
...
*HLH has been proposed for a variety of languages (\citealt{Cahill2007b}, \citealt{McPherson2016c}) and seems to reflect a desire to avoid multiple sharp changes in pitch in close proximity (cf. \citeauthor{HymanUniversals2007}'s (\citeyear{HymanUniverslas2007} Principle of Ups and Downs). There is independent evidence that *HLH is active within the word in Efik. As mentioned in §1, there are seven surface tonal shapes for Efik disyllabic nouns. All two-tone combinations of H and L are attested, as are the shapes H-HL, L-HL, and H-\textsuperscript{$\downarrow$}H, but the shapes H-LH and HL-H are not attested. Additionally, *HLH constrains the surface tones of reduplicated verb forms \citep{Glewwe2017}.
...
\begin{figure}
\includegraphics[width=.5\textwidth]{figures/glewwe-img5.png}
\caption{Tableau for \textup{ùsàn é\textsuperscript{$\downarrow$}jɨ́m}}
\label{fig:glewwe:6}
\end{figure}
...
% \ea\label{ex:glewwe:}
\begin{figure}
\includegraphics[width=.5\textwidth]{figures/glewwe-img6.png}
\caption{Tableau for \textup{úfɔ̀k ébwà}}
\label{fig:glewwe:7}
\end{figure}
...
\begin{figure}
\includegraphics[width=.5\textwidth]{figures/glewwe-img7.png}
\caption{Tableau for \textup{ùsàn é}\textup{\textsuperscript{$\downarrow$}}\textup{jɨ́m}}
\label{fig:glewwe:8}
\end{figure}
...
\begin{figure}
\includegraphics[width=.5\textwidth]{figures/glewwe-img8.png}
...
\gll \textup{ḿ-}\textup{\textsuperscript{$\downarrow$}}\textup{má}     \textup{ń-nɔ̀} \textup{à\~{w}â   íják} \\
     \textsc{\textup{1sg-past.aux}}  \textsc{1sg-}\textup{give}   \textup{cat}  {fish}\\
