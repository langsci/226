...
\begin{itemize}
\item \section{Efik Nominal Tonal Alternations}\end{itemize}
...
\begin{table}
    \centering
    \begin{tabularx}{\textwidth}{|c|r|cccc|ccX|}
        \lsptoprule
        \multicolumn{2}{|c|}{Underlying} &  \multicolumn{7}{c|}{Underlying Tonal Shape of Second Noun}\\
        \cline{3-9}
        \multicolumn{2}{|c|}{Tonal Shape of} & \multicolumn{4}{c|}{Group 1} & \multicolumn{3}{c|}{Group 2}\\
        \cline{3-9}
        \multicolumn{2}{|c|}{First Noun} & H-H & H-HL & H-L & L-L & L-H & L-HL\footnotemark{} & H-\textsuperscript{$\downarrow$}H\\
        \hline
        & H-H & & & & & & &  \\
        Alternation & H-L & & & & & & &  \\
        1 & L-L & \multicolumn{4}{c|}{H-L} & \multicolumn{3}{c|}{H-\textsuperscript{$\downarrow$}H} \\
         & L-H  & & & & & & & \\
         & H-H & & & & & & & \\
         \hline
        Alternation & H-HL  & \multicolumn{4}{c|}{L-L}&\multicolumn{3}{c|}{L-H}\\
        2 & L-HL  & & & & & & & \\
        \lspbottomrule
    \end{tabularx}
...
Realizing the H of the construction marker on the first syllable of the second noun when the first noun ends in the contour tone HL would violate *HLH<3, so the H of the construction marker changes to L. The tableau in \figref{fig:key:9} shows how the surface tones L-L are derived for the compound \textit{íkwâ} \textit{èbwà} ‘dog knife’: 
