...
There are various studies dealing with the noun class system in Sereer \cite{Fal1980, Faye1979, Faye2013, Renaudier2012};  however there is no agreement about the number of noun classes found in Sereer. For instance, \citealt{Faye2013} argues that Sereer has nine noun classes whereas for \citet{Fal1980} and \citet{McLaughlin1992} Sereer has thirteen noun classes. \tabref{tab:key:1} from \citet[284]{McLaughlin1992} gives a list of the different noun classes found in Sereer. 

\begin{table}
\caption{\label{tab:key:1}:Sereer noun classes}

\begin{tabularx}{\textwidth}{XXXX}
\lsptoprule 
Class & Prefix & Clitic determiner & Class content\\
...
\end{table}
  ...
  Indefiniteness is shown with the presence of a noun class marker (prefix in \tabref{tab:key:1}) before the noun whereas definiteness is shown through the presence of a prenominal and a postnominal class marker (clitic determiner in \tabref{tab:key:1}). 
...
\subsection{Experiencers in Sereer}\todo{subsection title identical to last one}
...
\ea \label{ex:tamba:3}
\langinfo{Italian}{Indo-European}{\citet{Belletti1988}}\\
...
These experiencer verbs come in two types. The first type must appear with a causative suffix whereas the second type does not occur with a causative suffix. Note that this is different from B \& R’ s Class II. Even though they do not use “causer”, my assumption is that a causer role is added to the subject of experiencer verbs of Class II. In \REF{ex:tamba:5}a and \REF{ex:tamba:5}b the verbs \textit{diidlat} ‘frighten’ 

and \textit{jaaxɗat} ‘worry’ are used transitively and are morphological complex. 
...
In \REF{ex:tamba:5a} and \REF{ex:tamba:5b}, the experiencers are in  object position. The other type of object experiencer in this class is shown in \REF{ex:tamba:6}.
...
\lsptoprule
\textbf{Class} \textbf{I} & Nominative Experiencer & Accusative theme\\
\textbf{Class} \textbf{II} & Nominative Causer & Accusative experiencer\\
\textbf{Class} \textbf{III} & Nominative theme & Dative experiencer\\
\lspbottomrule
\end{tabularx}
\end{table}

The remainder of this paper focuses on Class II and Class III experiencers by discussing syntactic differences between the two types of object experiencers that account for the classification in \tabref{tab:key:2}. More specifically, I show that they behave differently with respect to passivization, nominalization and antipassivization.
...
\ea[]
{\gll Awa a     fel  {}-a       o      njaaƈ onqe\\
Awa 3\textsc{sg} appeal   \textsc{perf}  \textsc{cl} child   \textsc{cl\textsubscript{def}}\\
...
Awa 3\textsc{sg}  miss   \textsc{perf}  \textsc{cl\textsubscript{}      } woman   \textsc{cl\textsubscript{} \textsc{def}}\\
...
Awa 3\textsc{sg}  appeal.to   \textsc{perf}  \textsc{cl\textsubscript{}} woman     \textsc{cl\textsubscript{def}}\\
...
\ea[]
{\gll Awa a     fel   a       o      njaaƈ onqe\\
Awa 3\textsc{sg} appeal   \textsc{perf} \textsc{cl}\textsc{\textsubscript{}        }boy    \textsc{cl\textsubscript{} \textsc{def}}\\
\glt `Awa appeals to the boy'}
\ex[] 
...
Polinsky further argues that crosslinguistically antipassive can be diagnosed through case marking, noun incorporation, agreement, word order, verbal affixation. She also provides evidence that antipassive can be found in accusative languages (also see \citealt{Heaton2017}). 
  ...
  In Sereer \citep{Renaudier2011}, and related languages like Wolof \cite{Creissels2008} antipassive is marked through verbal suffixation. 

\ea \label{ex:tamba:19}
\ea
\gll o     ɓox   ole   a     ŋat         {}-a       o   njaaƈ  onqe\\
 \textsc{cl} dog      \textsc{cl\textsubscript{def}}   3\textsc{sg}  bite         \textsc{perf}  \textsc{cl} boy     \textsc{cl\textsubscript{def}}\\
 \glt `The dog bit the boy'
\ex 
\gll o     ɓox      ole                             kaa                         ŋat     {}-a                    {}-a       (*o      njaaƈ onqe)\\
\textsc{cl} dog     \textsc{cl\textsubscript{def}} \textsc{ipfv.}3\textsc{sg}    bite   {}-\textsc{antip}       {}-\textsc{perf} {} {}\\
\glt `The dog bit'
\z
\z
...
Awa    \textsc{ipfv.}3\textsc{sg}    be scared   {}-\textsc{caus}    \textsc{{}-antip - perf}\\
\glt `Awa frightened'
\z
\z
...
Faatu          \textsc{ipfv.}3\textsc{sg}        surprise     \textsc{-antip}    \textsc{perf} \\
\glt `Faatu surprised'
\z
\z
...
\ea[]
{\gll Awa a      fel   -a       o      tew       oxe  \\
Awa 3\textsc{sg} appeal    \textsc{perf} \textsc{cl} woman  \textsc{cl\textsubscript{def}}\\
\glt `Awa appeals to the woman'}
\ex[*]
{\gll Awa      kaa           fel     {}-a        {}-a \\
 Awa \textsc{ipfv.}3\textsc{sg}       appeal     \textsc{-antip} \textsc{-perf}\\
...
\textsc{cl}   boy    \textsc{cl\textsubscript{def}}   3\textsc{sg} miss   \textsc{perf} \textsc{cl} woman  \textsc{cl\textsubscript{def}}\\
\glt `The woman misses the boy'} \label{ex:tamba:23a}
\ex[*]
{\gll o    njaaƈ   onqe      kaa                sooɓ      {}-a\\
o     njaaƈ  \textsc{cl\textsubscript{def}}     \textsc{ipfv.}3\textsc{sg}  miss {}-antip\\
