...
\gll \'a {\`ay\`aŋs\`e} (c\'i) s\`i b\'if\=u y{\'{\textepsilon}} Shey\\  
...
\ex[*]{...[\textsubscript{VP} [\textsubscript{V} l\'a][\textsubscript{CP} [\textsubscript{C} n\tikzmark{s13f}\`\textepsilon] [\textsubscript{FocP} rk\'ar f\=ɔ [\textsubscript{Foc} \'a\tikzmark{s13t}] [\textsubscript{FinP} [\textsubscript{Fin} c\'i ]]]]] \label{ex:becker:s13}
...
\ex[?]  {
\gll \`a mb\`o Tanko, m\`\textepsilon{} r\`iŋ ŋwe zh\sout{\v i} m\=u k\'\textopeno n\'i nf\sout{\=\i} zh\sout{\`i} \\  
...
\exi{B:}[]{
\gll \'a n\sout{\`i} ŋg\=ar (c\'i) m\`\textepsilon{} m\=u t\=a ny\`a \\  
...
\exi{B$'$:}[*]{
\gll \'a ŋg\=ar (c\'i) m\`\textepsilon{} m\=u t\=a ny\`a n\sout{\`i} \\  
...
\ex \label{ex:becker:s22}
	\begin{xlist}
		\exi{A:}[]{ 
			\gll \'a k\=\textepsilon{} (c\'i) nj\'iŋw\`ɛ f\=ɔ b\'i \`a \\ 
