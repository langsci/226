...
\ex *...[\textsubscript{VP} [\textsubscript{V} l\'a][\textsubscript{CP} [\textsubscript{C} n\tikzmark{s13f}\`\textepsilon] [\textsubscript{FocP} rk\'ar f\textipa{\=O} [\textsubscript{Foc} \'a\tikzmark{s13t}] [\textsubscript{FinP} [\textsubscript{Fin} c\'i ]]]]] \label{ex:becker:s13}
	\DrawXArrow[dashed]{{pic cs:s13f}}{{pic cs:s13t}}
\z \z
\vspace{3mm}
\noindent The complementizer {\em n\textipa{\`E}} would block movement of {\em \'a} to C, nevertheless {\em \'a} precedes the focused constituent. Hence, we assume the left periphery of the embedded clause in (\ref{ex:becker:s12}) to be composed as shown in figure \ref{fig:syntax:f1}.
\begin{figure}
...
\ea *[... \'a\sub{1} [\textsubscript{FocP} [\textsubscript{DP} Tán\tikzmark{s15f}kó\textsubscript{F}]\sub{2} [\textsubscript{Foc} t\sub{1}] [\textsubscript{TP} ... [\textsubscript{DP} [$_{D'}$ [\textsubscript{NP} nd\'ur] $\varnothing_D$] t\tikzmark{s15t}\sub{2}]...]]
...
\ea \relax[\textsubscript{FocP} \tikzmark{s16f2}\hspace{2mm}\tikzmark{s16f} [\textsubscript{Foc} c\'i] [\textsubscript{TP} ... [$_{F\tikzmark{s16t}P}$ \'a [\textsubscript{DP} [$_{D'}$ [\textsubscript{NP} nd\'ur] $\varnothing_D$] Tán\tikzmark{s16t2}kó\textsubscript{F}]]...]]
...
\ea *[... \'a\sub{1} [\textsubscript{FocP} [\textsubscript{DP} \textipa{N}g\tikzmark{s19f}\=ar\textsubscript{F}]\sub{2} [\textsubscript{Foc} t\sub{1}] [\textsubscript{TP} ... [\textsubscript{PP} [\textsubscript{P} n\sout{\`{\i}}] t\tikzmark{s19t}\sub{2}]...]]
...
\ea \relax[\textsubscript{FocP} \tikzmark{s20f2}\hspace{2mm}\tikzmark{s20f} [\textsubscript{Foc} c\'i] [\textsubscript{TP} ... [$_{F\tikzmark{s20t}P}$ \'a [\textsubscript{PP} [\textsubscript{P} n\sout{\`{\i}}] \textipa{N}g\tikzmark{s20t2}\=ar\textsubscript{F}]...]]
