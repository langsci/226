...
All of these properties also characterize Somali’s prosodic system, as we have seen in the preceding sections. The table in \tabref{extab:downing:16} summarizes the similarities in the prosodic systems of the two languages.


\begin{table} 
\caption{Comparison of the prosody of Swedish and Somali\label{extab:downing:16}\todo[inline]{Converted to Table from Ex. Please confirm if OK}}
\begin{tabular}{lll} 
\lsptoprule
& Somali & Swedish\\
\midrule
