...
\begin{tabbing}
\mc{pst}1 \hspace{.5cm} \= reciprocal verbal affix\kill
\& \>  associative plural\\
\mc{aux} \> auxiliary\\
c \> noun class\\
\mc{caus} \> causative\\
...
\mc{prn} \> pronoun\\
\mc{prs} \> present\\
\mc{pst}1 \> recent past\\
\mc{pst}2 \> remote past\\
