...
\ea \langinfo{English}{}{\citealt{Ionin2006}: 183)}\\
...
\ea
\ea\label{owusu:ex25}\langinfo{English}{}{\citealt[117]{AloniPort2015}}\\
...
\emph{Bi} therefore is more similar to \emph{un qualche} which has no NPI and deoFC functions. \\
 \tabref{tab:owusu:1}, taken from \citet{AloniPort2015}, shows some cross-linguistic comparison of epistemic indefinites; I have added \emph{bi} to this table.\\
...
\ea\label{owusu:ex450}\langinfo{English}{}{Aloni \& \citet{Port2015}}\\
...
\ea\label{owusu:ex45}\langinfo{English}{}{Aloni \& \citet{Port2015}}\\
...
\todo[inline]{Sort alphabetically}
