...
\tabref{tab:baird:1} shows the consonant inventory of Gurmancema for the dialect of study in this paper. 
...
of vowel deletion. \sectref{sec:baird:4} describes the 
data collection and analysis process. \sectref{sec:baird:5} presents a constraint-based analysis of 
a few illustrative phonological environments. In \sectref{sec:baird:6}, I will summarize my findings. 
...
\z
  ...
  the word-final vowel. A tableau showing an example is shown in \tabref{tab:baird:2}.
  
\todo{these look more like standard tables than tableaux}  
\begin{table}
...
\lsptoprule
{} &   p   &   p   &    &   \multicolumn{1}{c}{*V.V}   &   \multicolumn{1}{c}{*[+tns]\#}   &   \multicolumn{1}{c}{\textsc{Max} (V)}   &   \multicolumn{1}{c}{\textsc{Ident} (hi)}  \\
\midrule
...
\begin{tabularx}{\textwidth}{Xrrr *{4}{S[table-format=1.2]}} 
\lsptoprule
{} &  p   &  p   &    &   \multicolumn{1}{c}{*[+tns]\#}   &   \multicolumn{1}{c}{*TC}   &   \multicolumn{1}{c}{\textsc{Max} (V)}   &   \multicolumn{1}{c}{\textsc{Ident} (lo)}  \\
\midrule
...
\lsptoprule
   &      &      &     &               &                           &                                           & \multicolumn{2}{c}{\textsc{Ident}}\\\cmidrule(lr){8-9}
{} &  \multicolumn{1}{c}{p}   &  \multicolumn{1}{c}{p}   &    &   \multicolumn{1}{c}{*[+tns]\#}   &   \multicolumn{1}{c}{*TC}   &   \multicolumn{1}{c}{\textsc{Max} (V)}   &   \multicolumn{1}{c}{(lab)}   &   \multicolumn{1}{c}{(hi)}  \\
\midrule
 /bútíbu bwà/ & \multicolumn{1}{c}{obs} & pred & score & 6.14 & 4.55 & 3.62 & 3.62 & 2.99 \\
...
Tableaux showing the different behaviors of /a/ and /i/ preceded by /ɾ/ are shown in \tabref{tab:baird:5}.
...
\lsptoprule
   ...
   &      &      &    &   *R[ə] \&   \\
{} &  p   &  \multicolumn{1}{c}{p}   &    & \multicolumn{1}{c}{\textsc{Ident}(lo)} & \multicolumn{1}{c}{*[+tns]\#} & \multicolumn{1}{c}{*RC} & \multicolumn{1}{c}{\textsc{Max} (V)} & \multicolumn{1}{c}{\textsc{Ident} (hi)} & \multicolumn{1}{c}{*R[ə]\#} \\
\midrule
   /tìyúɾi ŋóagéni/ & obs & \multicolumn{1}{c}{pred} & score          & 8.13 & 6.14 & 6.04 & 3.62 & 2.99 & 0 \\
{a. [tìyúɾi ŋóagéni]} & 0.05 & \sim .04 & 6.14 & 0 &1 & 0 & 0 & 0 & 0 \\
{b. [tìyúɾə ŋóagéni]} & 0.91 & \sim .96 & 2.99 & 0 & 0&0 & 0 & 1 & 1 \\
{c. [tìyúɾ ŋóagéni]} &  0.04 &  \sim 0    & 9.66 & 0 &0& 1 & 1 & 0 & 0\\
\lspbottomrule
\end{tabular}
}
\end{table}
...
\lsptoprule
   &      &      &    &   \multicolumn{1}{c}{*R[ə] \&}    \\
{} &  p   & \multicolumn{1}{c}{p} & & \multicolumn{1}{c}{\textsc{Ident}(lo)} & \multicolumn{1}{c}{*[+tns\#]} & \multicolumn{1}{c}{\textsc *RC} & \multicolumn{1}{c}{\textsc{Max}(V)} & \multicolumn{1}{c}{\textsc{Ident} (lo)}   &   *R[ə] \\
\midrule
/abéla kúaɾi/ & obs & \multicolumn{1}{c}{pred} & \multicolumn{1}{c}{score} & 8.13 & 6.14 & 6.04 & 3.62 & 3.52 & 0\\
{a. [abéla kúaɾi]} & 1 & \sim .97 & 6.14 & 0 & 1 & 0 & 0 & 0 & 0\\
{b. [abélə kúaɾi]} & 0 & \sim 0  & 11.65 & 1 & 0 & 0 & 0 & 1 & 1\\
{c. [abél kúaɾi]}  & 0 & \sim .03 & 9.66 & 0 & 0 & 1 & 1 & 0 & 0\\
\lspbottomrule
\end{tabular}
}
\end{table}
...
\label{tab:baird:7} 
 ...
 \lsptoprule
{} &  p   &  \multicolumn{1}{c}{p} & & \multicolumn{1}{c}{*RC} & \multicolumn{1}{c}{\textsc{*[+tns\#]}} & \multicolumn{1}{c}{\textsc{Ident} (lo)} & \multicolumn{1}{c}{*R[ə]} & \multicolumn{1}{c}{\textsc{Max}(V)}\\
\midrule
    /abéla kúaɾi/ & \multicolumn{1}{c}{obs} & \multicolumn{1}{c}{pred} & \multicolumn{1}{c}{score} & 9.83 & 9.64 & 7.84 & 3.37 & 3.33\\
   \textipa{a. [abéla kúaɾi]} & 1 & \sim 0.81 & 9.64  & 0 & 1 & 0 & 0 & 0\\
   \textipa{b. [abélə kúaɾi]} & 0 & \sim 0.17 & 11.21 & 0 & 0 & 1 & 1 & 0\\
   \textipa{c. [abél kúaɾi]}  & 0 & \sim 0.02 & 13.16 & 1 & 0 & 0 & 0 & 1\\
 \lspbottomrule\end{tabularx}
\end{table}
...
\begin{tabular}{l*{8}{S}} 
\lsptoprule
{} &      &      &    &               &                     &  \multicolumn{2}{c}{\textsc{Ident}} & \\\cmidrule(lr){7-8}
{} &  \multicolumn{1}{c}{p}   &  \multicolumn{1}{c}{p}   &    &   \multicolumn{1}{c}{*[+tns]\#}   &   \multicolumn{1}{c}{\textsc{Max}(V)}   &   \multicolumn{1}{c}{(lab)}   &   \multicolumn{1}{c}{(hi)}   &   \multicolumn{1}{c}{\multirow{-2}{*}{\parbox{1.8cm}{\centering\textsc{Nasal\newline Assimilation}}}}  \\
\midrule
    /ilúomì dá/ & \multicolumn{1}{c}{obs} & \multicolumn{1}{c}{pred} & \multicolumn{1}{c}{score} & 6.14     & 3.62 & 3.62 & 2.99 & 2.55 \\
   \textipa{a. [ilúomì dá]}  & .07   & \sim .04 & 6.14 & 1    & 0  & 0 & 0 & 0\\
   \textipa{b. [ilúomə̀ dá]}  & .91   & \sim .91 & 2.99 & 0    & 0  & 0 & 1 & 0 \\
   \textipa{c. [ilúom dá]}   & .02   & \sim .04 & 6.17 & 0    &  1 & 0 & 0 & 1\\
   \textipa{d. [ilúon dá]}   & 0     & \sim .01 & 7.24 & 0    &  1 & 1 & 0 & 0\\
 \lspbottomrule
 \end{tabular}
 }
\end{table}
...
\lsptoprule
{} &      &      &    &               &                     &  \multicolumn{2}{c}{\textsc{Ident}} & \\\cmidrule(lr){7-8}
{} &  \multicolumn{1}{c}{p}   &  \multicolumn{1}{c}{p}   &    &   \multicolumn{1}{c}{*[+tns]\#}   &   \multicolumn{1}{c}{\textsc{Max}(V)}   &   \multicolumn{1}{c}{(lab)}   &   \multicolumn{1}{c}{(low)}   &   \multicolumn{1}{c}{\multirow{-2}{*}{\parbox{1.8cm}{\centering\textsc{Nasal\newline Assimilation}}}}  \\
\midrule
    /míɟemá pwá/ & \multicolumn{1}{c}{obs} & \multicolumn{1}{c}{pred} & \multicolumn{1}{c}{score} & 6.14 & 3.62 & 3.52 & 2.99 & 2.55 \\
   \textipa{a. [míɟemá pwá]} & 0 &   \sim .04 & 6.14 & 1 & 0 & 0 & 0 & 0\\
   \textipa{b. [míɟemə́ pwá]} & .33 & \sim .50 & 3.52 & 0 & 0 & 0 & 1 & 0 \\
   \textipa{c. [míɟem pwá]} & .67 &  \sim .46 & 3.62 & 0 & 1 & 0 & 0 & 1\\
 \lspbottomrule
 \end{tabular}
 }
\end{table}
